    ...
    def main(self):  
        ...
        if os.name == "nt":  
            ...
            ctypes.windll.kernel32.SetConsoleTitleW(
                "Nitro Generator / Checker - Made by Azerko#5014")
        else:  
            print(f'\33]0;Nitro Generator and Checker - Made by Azerko\a',
                  end='', flush=True)  
...
╚═╝  ╚═╝╚══════╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝  
        ...
        self.slowType("Made by : Azerko#5014", .02)
        time.sleep(1)  
